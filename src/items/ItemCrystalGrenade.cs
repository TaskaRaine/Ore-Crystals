...
namespace OreCrystals
{
    class ItemCrystalGrenade : Item
    {
        ...
        public override void OnHeldInteractStop(float secondsUsed, ItemSlot slot, EntityAgent byEntity, BlockSelection blockSel, EntitySelection entitySel)
        {
            ...
            EntityPos entityPos = new EntityPos(byEntity.Pos.X, byEntity.Pos.Y + byEntity.LocalEyePos.Y, byEntity.Pos.Z);
            ...
            EntityProperties type = byEntity.World.GetEntityType(new AssetLocation("orecrystals", "crystal_grenade-" + this.LastCodePart()));
            ...
            entity.ServerPos.SetPos(
                byEntity.ServerPos.BehindCopy(-1).XYZ.Add(0, byEntity.LocalEyePos.Y, 0)
            );
