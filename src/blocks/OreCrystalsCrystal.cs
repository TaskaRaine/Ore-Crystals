        ...
        public override void OnNeighbourBlockChange(IWorldAccessor world, BlockPos pos, BlockPos neibpos)
        {
            ...
            switch(codeLastPart)
            {
                ...
                case "ore_north":
                    ...
                    {
                        System.Diagnostics.Debug.WriteLine("North: " + pos + ", " + pos.NorthCopy(1));
                        world.BlockAccessor.BreakBlock(pos, null);
                    }
                    break;
                case "ore_south":
                    ...
                    {
                        System.Diagnostics.Debug.WriteLine("South: " + pos + ", " + pos.SouthCopy(1));
                        world.BlockAccessor.BreakBlock(pos, null);
                    }
                    break;
                case "ore_east":
                    ...
                    {
                        System.Diagnostics.Debug.WriteLine("East: " + pos + ", " + pos.EastCopy(1));
                        world.BlockAccessor.BreakBlock(pos, null);
                    }
                    break;
                case "ore_west":
                    ...
                    {
                        System.Diagnostics.Debug.WriteLine("West: " + pos + ", " + pos.WestCopy(1));
                        world.BlockAccessor.BreakBlock(pos, null);
                    }
                    break;
                default:
